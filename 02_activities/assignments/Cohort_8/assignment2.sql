...
SELECT
    vendor_name,
    product_name,
    SUM(5 * cost_to_customer_per_qty) AS total_money
...
VALUES ( 24, 'Sweet Apple Suace', 'medium', 3, 'unit', CURRENT_TIMESTAMP );
